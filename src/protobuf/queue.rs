...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct PopChunkRequest {}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PopChunkResponse {
    #[prost(message, optional, tag = "1")]
    pub chunk: ::core::option::Option<Chunk>,
}
...
pub mod queue_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/PublishChunk");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("queue.Queue", "PublishChunk"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn pop_chunk(
            &mut self,
            request: impl tonic::IntoRequest<super::PopChunkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PopChunkResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/PopChunk");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("queue.Queue", "PopChunk"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod queue_server {
    ...
    pub trait Queue: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn pop_chunk(
            &self,
            request: tonic::Request<super::PopChunkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PopChunkResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/queue.Queue/PublishChunk" => {
                    #[allow(non_camel_case_types)]
                    struct PublishChunkSvc<T: Queue>(pub Arc<T>);
                    impl<
                        T: Queue,
                    ...
                    for PublishChunkSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Queue>::publish_chunk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/queue.Queue/PopChunk" => {
                    #[allow(non_camel_case_types)]
                    struct PopChunkSvc<T: Queue>(pub Arc<T>);
                    impl<T: Queue> tonic::server::UnaryService<super::PopChunkRequest>
                    for PopChunkSvc<T> {
                        type Response = super::PopChunkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Queue>::pop_chunk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "queue.Queue";
